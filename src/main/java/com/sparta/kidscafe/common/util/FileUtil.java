...
public class FileUtil {
  ...
  public void uploadCafeImage(MultipartFile image, Long cafeId) throws IOException {
  ...
  public void uploadCafeImage(List<MultipartFile> images, Long cafeId) {
    try {
      for(MultipartFile image: images) {
        uploadCafeImage(image, cafeId);
      }
