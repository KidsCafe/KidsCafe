...
public enum ErrorCode {
  ...
  // FEE 관련 에러
  FEE_TABLE_UNAUTHORIZED("FEE_TABLE_UNAUTHORIZED", "일반 사용자는 가격책정의 권한이 없습니다.", HttpStatus.FORBIDDEN),
  ...
  // Coupon 관련 에러
  COUPON_TABLE_UNAUTHORIZED("COUPON_TABLE_UNAUTHORIZED", "일반 사용자는 쿠폰 발급의 권한이 없습니다.", HttpStatus.FORBIDDEN),
  COUPON_ISSUE_UNAUTHORIZED("COUPON_ISSUE_UNAUTHORIZED", "사장님은 선착순 쿠폰 지급받을 수 없습니다.", HttpStatus.FORBIDDEN),
  ...
  COUPON_ALREADY_ISSUED("COUPON_ALREADY_ISSUED", "이미 지급된 쿠폰입니다.", HttpStatus.BAD_REQUEST),
