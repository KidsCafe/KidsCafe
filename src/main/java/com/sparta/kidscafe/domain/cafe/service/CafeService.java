...
public class CafeService {
    ...
    public List<NaverCafeResponseDto> searchCafesFromNaver(String query, String region) {
        try {
            return naverMapService.searchCafes(query, region);
        } catch (Exception e) {
            throw new BusinessException(ErrorCode.EXTERNAL_API_ERROR, "네이버 API 호출 실패");
        }
    }
