...
import com.sparta.kidscafe.domain.cafe.service.NaverMapService;
...
public class CafeController {
  ...
  @GetMapping("/naver/cafes")
  public ResponseEntity<List<NaverCafeResponseDto>> searchCafesFromNaver(
          @RequestParam String query,
          @RequestParam String region
  ) {
    List<NaverCafeResponseDto> cafes = naverMapService.searchCafes(query, region);
    return ResponseEntity
            .status(HttpStatus.OK)
            .body(cafes);
  }
